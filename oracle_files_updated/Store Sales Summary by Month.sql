select a.sbs_no, a.store_no,a.store_code,extract(year from trunc(a.invc_post_date)) YEAR,extract(month from trunc(a.invc_post_date)) MONTH,
...
group by a.sbs_no, a.store_no,a.store_code,extract(year from trunc(a.invc_post_date)),extract(month from trunc(a.invc_post_date))
order by a.sbs_no, a.store_no,a.store_code,extract(year from trunc(a.invc_post_date)),extract(month from trunc(a.invc_post_date))