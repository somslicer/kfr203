select a.sbs_no, a.store_no,a.store_code,trunc(a.invc_post_date) "SALES_DATE",d.dcs_code DCS,
...
group by a.sbs_no, a.store_no,a.store_code,trunc(a.invc_post_date),d.dcs_code
order by a.sbs_no, a.store_no,a.store_code,trunc(a.invc_post_date),d.dcs_code
