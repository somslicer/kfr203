SELECT s.sbs_name
       ...
       TRUNC (a.created_datetime)
          AS "RCPT DATE",
       TO_CHAR (a.created_datetime, 'hh:mi:ss am')
          AS "RCPT TIME",
...
and =-=trunc(a.created_datetime)=-=
 Group By S.Sbs_Name, A.Store_Code, A.Doc_No, Trunc (A.Created_Datetime), To_Char (A.Created_Datetime, 'hh:mi:ss am'), sl.subloc_id, sl.subloc_code, sl.subloc_name,
       a.tender_name, i.upc, i.alu, b.dcs_code, b.vend_code, b.attribute, B.Item_Size, B.Description1, b.cost
order By S.Sbs_Name, A.Store_Code, A.Doc_No, Trunc(A.Created_Datetime), To_Char(A.Created_Datetime, 'hh:mi:ss am'),
