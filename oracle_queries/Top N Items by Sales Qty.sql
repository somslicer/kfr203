...
i.alu,to_char(i.upc) UPC,i.description1,i.description2,i.attribute,i.item_size,v.vend_code "VEND_CODE", v.vend_name "VEND_NAME",  i.last_sold_date,
...
dense_rank() over(partition by s.sbs_no, st.store_no order by sum(nvl(sal.qty,0)) desc) Rank
...
i.alu,i.upc,i.description1,i.description2,i.attribute,i.item_size,v.vend_code,v.vend_name, i.last_sold_date
) aa
where 1=1 and =-=ranks=-=