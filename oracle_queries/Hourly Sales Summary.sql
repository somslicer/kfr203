select a.sbs_no, a.store_code,trunc(a.created_Datetime) "DATE",to_char(a.created_datetime,'HH24') "HOUR",
...
and s.sid=d.sbs_sid and b.sbs_no=s.sbs_no and =-=s.sbs_no=-= and =-=trunc(a.created_datetime)=-= and =-=s.store_no=-=
...
group by a.sbs_no, a.store_code,trunc(a.created_Datetime),to_char(a.created_datetime,'HH24')
order by a.sbs_no, a.store_code,trunc(a.created_Datetime),to_char(a.created_datetime,'HH24')